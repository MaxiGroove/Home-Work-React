    ...
    return (
        <form className="board__form">
            ...
            <fieldset className="board__field board__field--theme">
                <label forHtml="theme" className="board__label board__label--theme">Тема:</label>
                <textarea
                    type="text"
            ...
            <fieldset className="board__field board__field--comment">
                <label forHtml="comment" className="board__label board__label--comment">Комментарий:</label>
                <textarea
                    type="text"
            ...
            <fieldset className="board__field board__field--date">
                <label forHtml="date" className="board__label board__label--date">Дата:</label>
                <input
                    type="datetime-local"
